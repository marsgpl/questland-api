...
module.exports = class extends Base {
    ...
    getDateIntervals(offsetDays, userTsMs) {
        let dateFrom = new Date(2018, 6, 5, 0, 0, 0, 1) // UTC
        let dateTo = new Date // UTC
    ...
    initExpress() {
        ...
        this.express.all("/reforge/api/eventTeams", async (req, res) => {
            ...
            let [ dateFrom, dateTo ] = this.getDateIntervals(offsetDays, userTsMs)
